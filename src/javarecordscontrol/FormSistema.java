...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\letic\\Downloads\\natacao (2).png")); // NOI18N
        ...
        btnLimpar.setFont(new java.awt.Font("Segoe UI Light", 1, 18)); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        LocalDate dataFormatada = LocalDate.parse(txtData.getText(), format);
        String nome = txtNome.getText();
        Double tempo = Double.parseDouble(txtTempo.getText());
        Recorde novoRecorde = new Recorde(dataFormatada, nome, tempo);
